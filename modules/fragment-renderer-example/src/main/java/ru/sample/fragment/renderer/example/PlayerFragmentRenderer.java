...
package ru.sample.fragment.renderer.example;
...
public class PlayerFragmentRenderer implements FragmentRenderer {
	...
	throws IOException {
		...
		httpServletRequest.setAttribute("testParam", "1234567890");
	...
	@Reference(
		target = "(osgi.web.symbolicname=ru.sample.fragment.renderer.example)"
	)
